 ...
 * затримки тут нікого не ламає.
 *
 * Кеш саме тут, у процесі, а не на CDN: у HTML сторінок зашитий лічильник
 * кошика, а CDN хостингу віддає збережену копію всім підряд, не дивлячись
 * на куки. Тут кешуються дані каталогу — однакові для всіх, — а сторінка
 * збирається для кожного своя.
 *
