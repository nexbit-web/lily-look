...
export type ProductVariantView = {
	...
	stock: number;
	/**
	 * Порядок, заданий у CRM. Потрібен на сторінці товару: список розмірів
	 * і кольорів збирається з варіантів, і без цього числа вони вишикувались
	 * би абеткою — не так, як задумав менеджер.
	 */
	position: number;
};
